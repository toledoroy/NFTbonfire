        ...
        if(isWeb3Enabled) {  
            ...
            if(params.handle){
                ...
                try {
                    ...
                    .catch((error) => { console.error("[CAUGHT] PagePersona() Error:", {error, isWeb3Enabled}); });
                }
                catch(error) {
                    console.error("[CAUGHT] PagePersona() Error:", {error, isWeb3Enabled});
                }
            }//Requsted: Handle
            //Log

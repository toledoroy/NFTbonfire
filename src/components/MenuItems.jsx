...
function MenuItems() {
  ...
  return (
    ...
    >
      ...
      <Menu.Item key="personas"><NavLink to="/personas">Personas</NavLink></Menu.Item>
      {/* <Menu.Item key="nftCollections"><NavLink to="/nftAll">Private Chat</NavLink></Menu.Item> */}
      <Menu.Item key="chat"><NavLink to="/chat">Private Chat</NavLink></Menu.Item>
